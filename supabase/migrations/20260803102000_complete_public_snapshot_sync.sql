...
begin
  ...
  public_data := jsonb_build_object(
    ...
    'rafflePrizes', new.data->'rafflePrizes', 'activeId', new.data->'activeId', 'stageOrders', new.data->'stageOrders',
    'skaters', coalesce((
      select jsonb_agg(jsonb_build_object(
        'id', s->'id', 'number', s->'number', 'firstName', s->'firstName', 'lastName', s->'lastName',
        'club', s->'club', 'track', s->'track', 'status', s->'status', 'stageNumber', s->'stageNumber'
      ))
